...
public class TitleScreen extends Window implements EventListener {
    ...
    private Button easy, okay, hard, insane, quit;  //EC: additional level
    ...
    public TitleScreen() {
        ...
        // Add all the buttons
        easy = new Button(280, 100, 160, 40, "1 - Easy");
        okay = new Button(280, 150, 160, 40, "2 - Medium");
        hard = new Button(280, 200, 160, 40, "3 - Hard"); 
        insane = new Button (280, 250, 160, 40, "4 - Insane!");  //EC
        ...
        int q = (int)System.currentTimeMillis() / 500;
        insane.setForegroundColor(Canvas.WHITE);            //EC
        insane.setBackgroundColor(Canvas.BLACK);            //EC
        insane.setBorderColor(null);                        //EC
    ...
    public void mouseClicked(double x, double y, String button) {
        if (button.equals("left")) {
            if (easy.containsPoint(x, y)) {
                ...
                selection = "hard";
                hide();
            } else if (insane.containsPoint(x, y)) {   //EC
                selection = "insane";                  //EC
                hide();                                //EC
